...
RUN yum fs filter languages en:US && yum fs filter documentation \
    ...
    && useradd vtop
USER vtop
LABEL base.os="centos7" base.version="7.3.1611" vtop.version="0.4.2" in.ind.hcv.centos7.vtop.vcs-ref-short="" \
      ...
      org.label-schema.vcs-ref="d301df6d9f47cf5f0b366085ed07803ecde2351a" org.label-schema.vendor="hvindin" \
      org.label-schema.docker.cmd.help="docker run docker.io/hvindin/centos7-vtop:latest --help" org.label-schema.version="4.2.0"
