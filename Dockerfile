...
RUN yum fs filter languages en:US && yum fs filter documentation \
    ...
    && useradd vtop
USER vtop
LABEL base.os="centos7" base.version="7.3.1611" vtop.version="0.4.2" in.ind.hcv.centos7.vtop.vcs-ref-short="2a395b7"
      ...
      org.label-schema.vcs-ref="2a395b7d6774b67d5c19d6f5b9b20debe24970ba" org.label-schema.vendor="hvindin" \
